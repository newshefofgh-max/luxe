      ...
      <main className="min-h-screen bg-page flex items-center justify-center px-4 py-24">
        ...
        >
          ...
          <div className="text-center mb-8">
            <p className="text-[#E91E8C] text-xs tracking-widest uppercase mb-2">Welcome Back</p>
            <h1 className="font-display text-3xl text-theme-text mb-2">Sign In</h1>
            <p className="font-arabic text-[var(--text-faint)] text-sm">تسجيل الدخول</p>
          </div>
          ...
          <div className="card p-8">
            ...
            <div className="mt-6 text-center text-sm text-[var(--text-faint)]">
              ...
              <Link href="/account/register" className="text-[#E91E8C] hover:underline">
                Register
              </Link>
            </div>
          </div>
